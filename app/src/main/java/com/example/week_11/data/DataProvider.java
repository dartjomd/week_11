package com.example.week_11.data;
...
public class DataProvider {
    ...
    public static List<Team> createSampleTeams() {
        ...
        teams.add(new Team("Flamengo", "Brazil", "Brasileirão", "Maracana", 1895));
        return teams;
    }
    ...
    public static List<Match> createSampleMatches() {
        ...
        matches.add(new Match("FC Barcelona", "Real Madrid", "2-1", "2023-04-10", "Camp Nou"));
        matches.add(new Match("Manchester United", "Liverpool", "0-3", "2023-03-15", "Old Trafford"));
        matches.add(new Match("Bayern Munich", "Borussia Dortmund", "4-2", "2023-04-01", "Allianz Arena"));
        matches.add(new Match("Juventus", "AC Milan", "1-1", "2023-03-20", "Allianz Stadium"));
        matches.add(new Match("Paris Saint-Germain", "Lyon", "3-0", "2023-04-05", "Parc des Princes"));
        matches.add(new Match("FC Barcelona", "Bayern Munich", "0-3", "2023-02-28", "Camp Nou"));
        matches.add(new Match("Manchester City", "Paris Saint-Germain", "2-1", "2023-03-08", "Etihad Stadium"));
        matches.add(new Match("Liverpool", "Ajax Amsterdam", "1-0", "2023-03-01", "Anfield"));
        return matches;
    }
}